<%@ Page Title="Frames @ OnSiteEyewear.ca" Language="C#" MasterPageFile="~/Site.master" 
    AutoEventWireup="true" CodeFile="Frames.aspx.cs" Inherits="WebFrames" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" />
    ...
    <ContentTemplate>
    <asp:ListView ID="lvGlasses" runat="server" GroupItemCount="3" OnPagePropertiesChanging="dpNextPrevious_PagePropertiesChanging">
        <EmptyDataTemplate>
            <div class="catalog">
        ...
        <ItemTemplate>
            <div class="catalogForEachItemSize">
                <asp:HyperLink ID="hlCatalogItemHeader" runat="server" SkinID="skinHyperLinkCatalogItemHeader" 
                    NavigateUrl='<%#Eval("glassesID", "~/Product/Frame.aspx?id={0}")  %>'>
                <div class="catalogItemName">
                    <%#Eval("name") %>
                </div>
                <div class="catalogPicture">
                    <img style="width: 150px; height: 75px" src='<%# Eval("image1", "Images/Frames/{0}") %>' alt="" />
                </div>
                ...
                <div class="catalogButton">
                    <asp:Button ID="btnDetails" runat="server" Text="Details"  
                        PostBackUrl='<%#Eval("glassesID", "~/Product/Frame.aspx?id={0}")  %>'></asp:Button>
                </div>
                </asp:HyperLink>
            </div>
        </ItemTemplate>
        <LayoutTemplate>
            <div id="groupPlaceholderContainer" class="catalog">
                <div class="catalogController" >
                    ...
                    <div class="catalogDataPager">
                        <asp:DataPager ID="dpNextPrevious1" runat="server" PagedControlID="lvGlasses" PageSize="9">
                            <Fields>
                ...
                <div class="catalogController" style="float: right;">
                    ...
                    <div class="catalogDataPager">
                        <asp:DataPager ID="dpNextPrevious2" runat="server" PagedControlID="lvGlasses" PageSize="9">
                        <Fields>
                            <asp:NextPreviousPagerField ButtonType="Button" ShowFirstPageButton="true" 
                                ShowNextPageButton="false" ShowPreviousPageButton="false"
                                FirstPageText="&lt;&lt;" />
