<%@ Page Title="Accessories @ OnSiteEyewear.ca" Language="C#" MasterPageFile="~/Site.master" 
    AutoEventWireup="true" CodeFile="Accessories.aspx.cs" Inherits="Accessories_Default" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" />
    ...
    <ContentTemplate>
    <asp:ListView ID="lvAccessories" runat="server" GroupItemCount="3" OnPagePropertiesChanging="dpNextPrevious_PagePropertiesChanging">
        <EmptyDataTemplate>
            <div class="catalog">
                ...
                <div class="fullSize" style="margin: 20px 0px;">
                    There are no accessories for this catalog.
                </div>
        ...
        <ItemTemplate>
            <div class="catalogForEachItemSize">
                <asp:HyperLink ID="hlCatalogItemHeader" runat="server" SkinID="skinHyperLinkCatalogItemHeader" 
                    NavigateUrl='<%#Eval("itemID", "~/Product/Accessory.aspx?id={0}")  %>'>
                <div class="catalogItemName">
                    <%#Eval("name") %>
                </div>
                <div class="catalogPicture" style="height: 200px;">
                    <img src='<%# Eval("image", "Images/Accessories/{0}") %>' alt="" />
                </div>
                ...
                <div class="catalogButton">
                    <asp:Button ID="btnDetails" runat="server" Text="Details"  
                        PostBackUrl='<%#Eval("itemID", "~/Product/Accessory.aspx?id={0}")  %>'></asp:Button>
                </div>
                </asp:HyperLink>
            </div>
        </ItemTemplate>
        <LayoutTemplate>
            <div id="groupPlaceholderContainer" class="catalog">
                <div class="catalogController" >
                    ...
                    <div class="catalogDataPager">
                        <asp:DataPager ID="dpNextPrevious1" runat="server" PagedControlID="lvAccessories" PageSize="9">
                            <Fields>
                ...
                <div class="catalogController" style="float: left;">
                    <div class="catalogBtnViewAll">
                        <asp:Button ID="btnViewAll2" runat="server" Text="View All" OnClick="btnViewAll_Click" />
                    </div>
                    <div class="catalogDataPager">
                        <asp:DataPager ID="dpNextPrevious2" runat="server" PagedControlID="lvAccessories" PageSize="9">
                        <Fields>
                            <asp:NextPreviousPagerField ButtonType="Button" ShowFirstPageButton="true" 
                                ShowNextPageButton="false" ShowPreviousPageButton="false"
                                FirstPageText="&lt;&lt;" />
    ...
    <Triggers>
        ...
        <asp:AsyncPostBackTrigger ControlID="cblManufacturer" EventName="SelectedIndexChanged" />
    </Triggers>
    </asp:UpdatePanel>
</asp:Content>
